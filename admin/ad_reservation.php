...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="ad_reservation.php" class="nav-item active">
            ...
            <div class="detail-container">
                ...
                <div class="detail-card">
                    ...
                    <table class="detail-table">
                        ...
                        <tr>
                            <td>Total</td>
                            <td class="total-amount"><?php echo number_format($reservation['total'], 0); ?> TD</td>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>
            ...
            <div class="filter-bar">
                <form method="GET" action="" class="filter-form">
                    <select name="statut">
                        ...
                        <option value="Confirmed" <?php echo $statut_filter == 'Confirmed' ? 'selected' : ''; ?>>Confirmed
                        </option>
                        <option value="Cancelled" <?php echo $statut_filter == 'Cancelled' ? 'selected' : ''; ?>>Cancelled
                        </option>
                        <option value="Completed" <?php echo $statut_filter == 'Completed' ? 'selected' : ''; ?>>Completed
                        </option>
                    </select>
                    <input type="text" name="search" placeholder="Search client or car"
