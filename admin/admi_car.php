...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="admi_car.php" class="nav-item  active">
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            <h3><i class="fas fa-<?php echo $edit_voiture ? 'edit' : 'plus'; ?>"></i>
                <?php echo $edit_voiture ? 'Modify a car' : 'Add a car'; ?></h3>
            ...
            <form method="POST">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="marque"
                            value="<?php echo $edit_voiture ? htmlspecialchars($edit_voiture['marque']) : ''; ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-car-side"></i> Model</label>
                        <input type="text" name="modele"
                            value="<?php echo $edit_voiture ? htmlspecialchars($edit_voiture['modele']) : ''; ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-calendar"></i> Year</label>
                        <input type="number" name="annee"
                            value="<?php echo $edit_voiture ? $edit_voiture['annee'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-tag"></i> Price / day (DT)</label>
                        <input type="number" step="1" name="prix"
                            value="<?php echo $edit_voiture ? $edit_voiture['prix'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="places"
                            value="<?php echo $edit_voiture ? $edit_voiture['places'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-suitcase"></i> Luggage</label>
                        <input type="number" name="bagages"
                            value="<?php echo $edit_voiture ? $edit_voiture['bagages'] : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-image"></i> Image in front (URL)</label>
                        <input type="text" name="imgfront" placeholder="imgVoitures/xxx.jpg"
                            value="<?php echo $edit_voiture ? htmlspecialchars($edit_voiture['imgfront']) : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-image"></i> Image interior (URL)</label>
                        <input type="text" name="imginter" placeholder="imgVoitures/xxx.jpg"
                            value="<?php echo $edit_voiture ? htmlspecialchars($edit_voiture['imginter']) : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-image"></i> Image side (URL)</label>
                        <input type="text" name="imgcote" placeholder="imgVoitures/xxx.jpg"
                            value="<?php echo $edit_voiture ? htmlspecialchars($edit_voiture['imgcote']) : ''; ?>">
                    </div>
                </div>

                <button type="submit" name="<?php echo $edit_voiture ? 'edit_voiture' : 'add_voiture'; ?>"
                ...
                <?php if ($edit_voiture): ?>
                    <a href="admi_car.php" class="btn-back"
                        style="margin-top: 10px; display: inline-block; width: 100%; text-align: center;">
                    ...
                    <?php if ($result && $result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <img src="../<?php echo htmlspecialchars($row['imgfront']); ?>" class="vehicle-img"
                                        alt="Véhicule">
                                </td>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="admi_car.php?delete=<?php echo $row['id']; ?>" class="btn-action btn-delete"
